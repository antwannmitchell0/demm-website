    ...
    <main className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="text-2xl font-bold text-yellow-400">DEMM Marketing</div>
          <div className="hidden md:flex gap-8">
            <a href="#why" className="hover:text-yellow-400 transition">Why Us</a>
      ...
      <section className="min-h-screen flex items-center justify-center px-6 pt-20 relative overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-yellow-400/5 rounded-full blur-3xl animate-pulse delay-700"></div>
        </div>

        <div className="max-w-3xl mx-auto text-center">
          {/* Agent greeting */}
          <div className={`mb-8 transition-all duration-700 ${showAgentMessage ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
            Small businesses are leaving $5,000–$20,000 on the table every month.
            <br />
            <span className="text-yellow-300 font-semibold">We show you how to capture it.</span>
          </p>
          ...
          <p className="text-sm text-gray-400">
            No credit card required. Cancel anytime. <span className="text-yellow-300">Guarantee: Save 10 hours/month or get 100% refund.</span>
          </p>
        </div>
      ...
      {/* Pain Points Section */}
      <section id="why" className="py-20 px-6 bg-gradient-to-b from-black to-gray-950">
      ...
      <section id="pricing" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="mb-6">
                  <div className="flex items-baseline gap-1 mb-2">
                    <span className="text-4xl font-black text-yellow-400">${tier.price}</span>
          ...
          <div className="bg-gray-900/50 border border-gray-700 rounded-lg p-8 mb-12">
            <h3 className="text-2xl font-bold mb-6">What You Get vs. Hiring an Agency</h3>
          ...
          <div className="bg-gray-900/30 border border-gray-700 rounded-lg p-8">
            ...
            <div className="space-y-4">
              <div className="border-b border-gray-700 pb-4">
                <p className="font-bold text-yellow-300 mb-2">Can I really cancel anytime?</p>
                <p className="text-gray-400">Yes. No cancellation fees. No long-term contracts. We'll even help you set up a competitor if you want.</p>
              </div>
              <div className="border-b border-gray-700 pb-4">
                <p className="font-bold text-yellow-300 mb-2">What if I don't save 10 hours?</p>
                <p className="text-gray-400">We refund 100% of your money, no questions asked. We're confident you will.</p>
              </div>
              <div>
                <p className="font-bold text-yellow-300 mb-2">How long does setup take?</p>
                <p className="text-gray-400">7 days free trial. No setup required. Connect your business info and start getting results immediately.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* CTA Footer */}
      <section id="contact" className="py-20 px-6 bg-gradient-to-b from-gray-950 to-black border-t border-yellow-400/20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-sm text-gray-500">
            Questions? Email <a href="mailto:hello@demmmarketing.com" className="text-yellow-400 hover:underline">hello@demmmarketing.com</a>
          </p>
        </div>
      </section>
      ...
      <footer className="border-t border-gray-800 py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <p>&copy; 2026 DEMM Marketing. All rights reserved.</p>
